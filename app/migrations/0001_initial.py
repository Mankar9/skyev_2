# Generated by Django 3.2.3 on 2021-08-07 03:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruta_consolidado', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.llaveregistro')),
            ],
        ),
        migrations.CreateModel(
            name='Prefetch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruta', models.CharField(blank=True, max_length=100, null=True)),
                ('fecha_cargue', models.DateField(blank=True, null=True)),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.estadoinforme')),
                ('evidencia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.evidencia')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='caso',
            name='estado',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='app.estadocaso'),
        ),
        migrations.AddField(
            model_name='caso',
